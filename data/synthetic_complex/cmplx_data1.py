...
# samples files
healthy_path = Path('../real/GeneMatrix_H3K4me3_healthy.csv')
diseaseA_path = Path('../real/GeneMatrix_H3K4me3_crc.csv')
diseaseB_path = Path('../real/GeneMatrix_H3K4me3_sclc.csv')
# thetas files
theta_A_path = Path('../real/theta_CRC_passedQC.csv')
theta_B_path = Path('../real/SCLC_theta.csv')
